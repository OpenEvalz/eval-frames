#!/usr/bin/env python3
"""Run ONE problem of frames through TrustedRouter and emit a reproducibility bundle.
...
TASK = "inspect_evals/frames_baseline"
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one frames problem via TrustedRouter")
